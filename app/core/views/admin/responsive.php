...
<head>
  ...
  <link href="public/admin/assets/css/table-responsive.css" rel="stylesheet">
...
<body>
            ...
            <div class="content-panel">
              ...
              <section id="unseen">
                <div  style="text-align: center; margin-top:25px">
                  ...
                  <h1 class="" style="text-align: center; margin-top:25px; background-color: rgb(150, 222, 135);">Les Demandes</h1>
                    <?php	
                      require_once 'app/core/database/models.php';
                      $model = new Model();
                      $demandes = $model->demande()->fetchAll();
                  ...
                  <table id="gestion" >
                    ...
                    <?php foreach($demandes as $valider): ?>
                    <tr>
                    <td><?= $valider['nom_c']?></td>
                    <td><?= $valider['prenom_c']?></td>
                    <td><?= $valider['email']?></td>
                    <td><?= $valider['telephone']?></td>
                    <td><?= $valider['niveau']?></td>
                    <td><?= $valider['qualification']?></td>
                    <td><?= $valider['titre']?></td>
                    <td><?= $valider['nom_e']?></td>
  ...
  <script class="asset/include" type="text/javascript" src="public/admin/assets/lib/lib/jquery.dcjqaccordion.2.7.js"></script>
