      ...
      <section class="wrapper">
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Valider les inscriptions</h4>
                <hr>
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <?php	
                    ...
                    $profile = new Model();
                    $candidats = $profile->liste_candidats_by(0)->fetchAll();
                  ...
                  <?php foreach($candidats as $candidat): ?>
                    ...
                    <td>
                      <?php
                        if ($candidat['isValidated'] == 0) {
                          echo "en attente";
                        } else if($candidate['isValidated'] == 1) {
                          echo "acceptée";
                        }
                        else {
                          echo "refusée";
                    ...
                    <td>
                      <a href="?action=1&target=<?=$candidat['id'] ?>" class="btn btn-success">Valider</a>
                      <a href="?action=2&target=<?=$candidat['id'] ?>" class="btn btn-danger">Refuser</a>
                    </td>
        ...
        <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Valider les Comptes employeurs</h4>
                <hr>
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <?php	
                    require_once 'app/core/database/models.php';
                    $profile = new Model();
                    $employeurs = $profile->liste_employes_by(0)->fetchAll();
                  ...
                  <?php foreach($employeurs as $employeur): ?>
                    ...
                    <td><a href="#"><?php echo $employeur['siteweb']?></a></td>
                    <td>
                      <?php
                    ...
                    <td>
                      <a href="?actionemp=1&target=<?=$employeur['id'] ?>" class="btn btn-success">Valider</a>
                      <a href="?action=2&target=<?=$employeur['id'] ?>" class="btn btn-danger">Refuser</a>
                    </td>
