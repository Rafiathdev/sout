			...
			<div class="row">
					...
					<div class="header-area hidden-menu-bar stick" id="sticker">
						...
						<div class="mainmenu">
							...
							<ul class="float_left">
								...
								<li class="has-mega gc_main_navigation"><a href="/offer" class="gc_main_navigation"> Offres&nbsp;<i class="fa fa-angle-down"></i></a>
									<!-- mega menu start -->
									<ul>
				...
				<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm hidden-xs">
					...
					if (is_authenticate() && $_SESSION['user_info']['type'] == 1) {
						...
						<ul>
							<li><a href="/profile?actor=company"><i class="fa fa-user"></i>&nbsp; '.$_SESSION['user_info']['name'].'</a>
							
							<li ><a href="/logout"><i class="fa fa-sign-in"></i>&nbsp; Logout</a></li></li>

							<li ><a href="/logout"><i class="fa fa-sign-in"></i>&nbsp; Voir mes offres</a></li>

							<li ><a href="/logout"><i class="fa fa-sign-in"></i>&nbsp; Voir candidature</a></li>
							
							<li ><a href="/logout"><i class="fa fa-sign-in"></i>&nbsp; Programmation entretient</a></li>		
							
							<li ><a href="/logout"><i class="fa fa-sign-in"></i>&nbsp; Mise a jour</a></li>		
							
						</ul>
					</div>
						'; // configure le routeur pour rediriger vers le profile d'une entreprise
						...
						<ul>
							...
							<li ><a href="/logout"><i class="fa fa-sign-in"></i>&nbsp; Voir mes candidatures</a></li>
							
							<li ><a href="/logout"><i class="fa fa-sign-in"></i>&nbsp; Mise a jour</a></li>				
							
						</ul>
					</div>
						'; // configure le routeur pour rediriger vers le profile d'un candidat
					} else {
							...
							<ul class="float_left">
								...
								<li class="parent gc_main_navigation"><a href="#" class="gc_main_navigation">Menu &nbsp;<i class="fa fa-angle-down"></i></a>
									...
									<ul>
										...
										<li class="parent"><a href="company_listing.html">Mes offres</a></li>
										<li class="parent"><a href="company_listing_single.html">Voir candidature</a></li>
										<li class="parent"><a href="candidate_listing.html">Programmer entretien</a></li>
							...
							<ul class="float_left">
								...
								<li class="parent gc_main_navigation"><a href="#" class="gc_main_navigation">Menu &nbsp;<i class="fa fa-angle-down"></i></a>
									...
									<ul>
										...
										<li class="parent"><a href="company_listing_single.html">Voir les offres</a></li>
